        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="max-w-2xl mx-auto px-6 py-10">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                    ...
                    <p className="text-gray-400 text-sm mb-8">Modifica los campos que necesites y guarda los cambios.</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex gap-3 pt-2">
                            <button
                                type="button"
                                onClick={() => navigate(`/actividad/${id}`)}
                                className="flex-1 py-3 rounded-lg border border-gray-200 text-gray-600 font-bold hover:border-gray-400 transition-colors"
                            >
                                Cancelar
                            </button>
                            <button
                                type="submit"
                                disabled={guardando}
                                className="flex-1 bg-black text-white py-3 rounded-lg font-bold flex items-center justify-center gap-2 hover:bg-gray-800 disabled:bg-gray-400 transition-colors"
                            >
                                {guardando ? (
